   ...
   return (
     <Container>
        <Left>
          <Logo> AURA </Logo>
          <SocialContainer>
            <SocialIcon ><BsFacebook color="3B5999"/></SocialIcon>
            <SocialIcon ><BsInstagram color="E4405F"/></SocialIcon>
            <SocialIcon ><BsTwitter color="55ACEE"/></SocialIcon>
            <SocialIcon ><BsPinterest color="E60023"/></SocialIcon>
          </SocialContainer>
        </Left>
        <Center>
